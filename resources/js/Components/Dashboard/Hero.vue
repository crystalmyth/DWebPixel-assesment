...
const onSubmit = async () => {
    router.get('/dashboard', formData.value, {
        preserveState: true,
        replace: true,
    });
}
                ...
                <div
                    ...
                    <div class="flex-1 flex items-center border-r">
                        ...
                        <input placeholder="Job title or keyword"
                            ...
                            type="text" v-model="formData.search">
                    </div>
                    <div class="flex-1 flex items-center">
                        ...
                        <input placeholder="Location"
                            class="py-4 shadow-none border-none focus:outline-none focus:ring-0 outline-none ring-0"
                            type="text" v-model="formData.location">
                    </div>
                    <button type="submit" class="bg-brand px-6 text-sm font-medium py-2 rounded-full text-white mr-3">Find
                        jobs</button>
                </div>
            </form>
        </div>
